  ...
  return (
    <div className="">
      ...
      <form
        ...
        className="z-10  m-auto  absolute right-0 left-0 py-3  flex flex-col gap-2  text-white items-center w-full md:w-3/12 bg-black  my-36 pt-2 pb-8 px-6 rounded-2xl bg-opacity-80"
      >
